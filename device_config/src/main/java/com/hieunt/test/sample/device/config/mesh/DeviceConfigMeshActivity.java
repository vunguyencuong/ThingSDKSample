package com.hieunt.test.sample.device.config.mesh;
...
import com.hieunt.test.sample.device.config.mesh.configByApp.SubConfigAppActivity;
import com.hieunt.test.sample.device.config.mesh.configByGateway.SubConfigGatewayActivity;
