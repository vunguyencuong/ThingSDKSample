package com.hieunt.test.sample.device.config.qrcode;
...
import com.hieunt.test.sample.device.config.util.qrcode.QRCodeUtil;
...
public class QrCodeConfigActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEtInputWifiSSid.setText("SwDept_T3");
        mEtInputWifiPwd.setText("1235813aA@");
    }
